...
class User extends \BackendBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackendBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'BackendBundle\\Entity\\User' . "\0" . 'role', '' . "\0" . 'BackendBundle\\Entity\\User' . "\0" . 'name', '' . "\0" . 'BackendBundle\\Entity\\User' . "\0" . 'surname', '' . "\0" . 'BackendBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'BackendBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'BackendBundle\\Entity\\User' . "\0" . 'createdAt'];
        }
