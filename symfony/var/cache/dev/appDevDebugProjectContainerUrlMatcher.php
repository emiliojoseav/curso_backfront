    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/task')) {
            ...
            if (0 === strpos($pathinfo, '/task/edit') && preg_match('#^/task/edit(?:/(?P<id>[^/]++))?$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'task_edit')), array (  '_controller' => 'AppBundle\\Controller\\TaskController::editAction',  'id' => NULL,));
            }
            not_task_edit:
            ...
            if ('/task/list' === $pathinfo) {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\TaskController::tasksAction',  '_route' => 'tasks_list',);
            }
            not_tasks_list:
            ...
            if (0 === strpos($pathinfo, '/task/detail') && preg_match('#^/task/detail(?:/(?P<id>[^/]++))?$#s', $pathinfo, $matches)) {
                if ('POST' !== $canonicalMethod) {
                    $allow[] = 'POST';
                    goto not_tasks_detail;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'tasks_detail')), array (  '_controller' => 'AppBundle\\Controller\\TaskController::taskAction',  'id' => NULL,));
            }
            not_tasks_detail:
